...
export default function Ddoctor() {
  ...
  const handleSubmit = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorUsername",
      {
        userId: userId,
  ...
  const handlephone = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorPhoneNum1",
      {
        userId: userId,
  ...
  const handleadd = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorAddress1",
      {
        userId: userId,
  ...
  const handlework = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorWorkTime1",
      {
        userId: userId,
  ...
  const handledesc = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorDescription1",
      {
        userId: userId,
  ...
  const handlegov = async () => {
    await axios.post(
      "https://ertdemo.azurewebsites.net/api/Doctor/UpdateDoctorGovernorates1",
      {
        userId: userId,
          ...
          <div className="row mt-3">
            <div className="item">
              <textarea
                ...
                className="form-control"
              />
              <button className='btn btn-primary mt-3' onClick={handledesc}>Submit</button>
            </div>
          </div>
          <div className="row mt-3">
            <div className="item">
